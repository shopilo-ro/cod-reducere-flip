#!/usr/bin/env python3
"""
Fetch coduri de reducere Flip de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/flip.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/flip.ro"
STORE_NAME = "Flip"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Flip de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-flip)"
    }
    try:
