#!/usr/bin/env node
/**
 * Fetch coduri reducere Flip de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/flip.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/flip.ro";
const STORE_NAME  = "Flip";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-flip)" }
  });
